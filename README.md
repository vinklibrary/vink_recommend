...
# 10. Papers
1. [Generation Meets Recommendation: Proposing Novel Items for Groups of Users](https://arxiv.org/pdf/1808.01199.pdf)**RecSys18**
...
1. 并非一锤子买卖
2. item一定程度上是有限的。
3. 推荐系统会影响经济系统。 并且一般有两个经济系统，充值系统以及内部消费系统。
4. 推荐策略有时候比算法模型本身更重要！！！
5. （折扣商店）中，点击率和购买率之间存在偏差。少见的商品点击率高但是购买转化率特别低。
6. 跟游戏强相关，有些mmorpg游戏，会大R友好。所以即使反馈问题需要解决，有些大R觉得推得特别不理想之类的。
